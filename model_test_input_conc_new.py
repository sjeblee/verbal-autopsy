...
def main():
    ...
    for i in ind_list:
        ...
        testids, testlabels, predictedlabels = test(model,input_test,arg_test_feats,i,emb_dim_char=emb_dim_char)
...
def test(model,input_test, testfile,ind,emb_dim_char=24,anova_filter=None, hybrid=False, rec_type=None, kw_cnn=None, threshold=0.01):
    print("testing...")
    stime = time.time()
    testlabels = []
    testX = []
