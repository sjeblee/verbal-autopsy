...
out_model_filename = "./output/model_child_rnn_128_2.pt"
out_text_filename = "output/out_child_rnn_test_128_2.txt"
out_results_filename = 'output/out_child_rnn_results.txt'
...
def test(model):
    ...
    # for child in root.findall('Child_Anonymous'):
    #     print(child.find('MG_ID').text)
    # for child in root:
    #     try:
    #         print(child.find('narrative').text,11111)
    #         print(child.find('cghr_cat').text,2)
    #     except AttributeError:
    #         print('None')
    for child in root:
        MG_ID = child.find('MG_ID')
