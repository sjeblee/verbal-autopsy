...
python pipeline.py --name "nn1x_narr" --model "nn" --modelname "nn1a_all7" --train "all" --test "child" --features "type,narr_count" | tee ../../data/nn1x_narr/out-all-child7.txt
...
#featureset="narr_count_new" # Name of the feature set for feature file
#features="type,narr_count" # type, checklist, narr_bow, narr_tfidf, narr_count, narr_vec, kw_bow, kw_tfidf
#model="svm" # svm, knn, nn, lstm, nb, rf
#modelname="svm"
